...
# RAG-файлы тарифицируются как обычное хранилище: 50 ₽/мес за 100 МБ
# (scheduler.storage_billing_tick — общий проход по StoredAsset + KnowledgeFile).
#   - 50 файлов на бота/агента
#   - 50 МБ на файл
#   - 2 ГБ суммарно на юзера (across всех его ботов и агентов)
MAX_FILES_PER_OWNER = 50
MAX_FILE_BYTES = 50 * 1024 * 1024             # 50 МБ
MAX_TOTAL_BYTES_PER_USER = 2 * 1024 * 1024 * 1024  # 2 ГБ суммарно
