...
**В новом чате:** уточни 6 вопросов в roadmap (тариф / лимиты Knowledge Hub / автоответчик vs боты / миграция / маркетплейс скилов / кто пишет промпты), потом → Итерация 1 (Knowledge Hub: category column + auto-classify + filter).
